...
/**
 * This class provides a wrapper for network errors when making requests to Visier Profile Management APIs
 */
export class VisierProfileManagementError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierProfileManagementError";
